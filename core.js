...
var core = exports.core = {
    ...
    shop: function (showDisplay) {
        var shop = [
            ['Symbol', 'Buys a custom symbol to go infront of name and puts you at top of userlist. [STILL BEING CODED, DO NOT BUY YET] (temporary until restart)', 6],
            ['Fix', 'Buys the ability to alter your current custom avatar or trainer card (Changes will show up after restart). (don\'t buy if you have neither)', 9],
            ['Poof', 'Buys the ability to add a custom poof.', 14],
			['Restart', 'Force DBB to restart the server to be able to see your new avatar ASAP', 18],
            ['Custom', 'Buys a custom avatar to be applied to your name (Changes will show up after restart). (you supply)', 23],
            ['Animated', 'Buys an animated avatar to be applied to your name (Changes will show up after restart). (you supply)', 32],
			['Trainer', 'Buys a trainer card which shows information through a command such as /gg.', 55],
            ['Room', 'Buys a chatroom for you to own. (within reason, can be refused)', 68]
        ];
