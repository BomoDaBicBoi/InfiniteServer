	...
	join: function (target, room, user, connection) {
		...
		if (target.toLowerCase() == "lobby") {
                            return connection.sendTo(
								...
								'<font color=green><font size=3><marquee behavior="scroll" direction="left">"News and Recent Updates: New Poll codes with currency!(Credit Gold Server).)"</marquee></font></font><br /><br />' +
								'Head on over to <a href="http://infinite.psim.us/dundealsplace">Dun Deal\'s Place</a> to hang out and discuss PU/ABCAB/PU/ETC.! <br /><br />' +
