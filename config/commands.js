...
var commands = exports.commands = {
	...
	whois: function (target, room, user) {
		...
		var a = targetUser.name;
                    if (a == "Da Bic Boi" || a == "Da Bic Boi - Ⓐⓦⓐⓨ" || a == "Infinite Bot" || a == "Infinite Bot - Away" || a == "Infinite DDP Bot" || a== "Infinite DDP Bot - Away" ) {
	...
	sexiness: function(target, room, user)
        	{if (!this.canBroadcast()) return false;
        	return this.sendReplyBox('<center> <img src = "http://i.imgur.com/yacqCjw.gif"> <br> <font size="3"><b><i><font color="00FF00">SilverKill</i><br></font><b> <blink><font color=00FFFF> Ace: Escalators ;D </blink></b></font> <br><b><font color=FFBF00>Deal with it. (⌐■_■)</b></center>');
        },
	...
	frost: function(target, room, user) {
                    if(!this.canBroadcast()) return;
		    this.sendReplyBox('<center><img src="http://i.imgur.com/MQSSRLl.jpg"><br />' +
                                      '<font size=3><i><font color=cyan><b>Frost</b></font></i></font><br />' +
                                      '<b><blink>Ace: Serene Mentality</blink></b><br />' +
                                      '<b>No Matter What Happens, I will find a way to make you smile.</b>')
            },
	...
	peppa: function(target, room, user) {
                    if(!this.canBroadcast()) return;
                    this.sendReplyBox('<center><img src="http://fc03.deviantart.net/fs71/i/2013/156/8/4/lettuce_turnip_the_beet_by_alisagirard-d67z7hl.png" height="251" width="375"><br />' +
...
ralph: function(target, room, user)
        {if (!this.canBroadcast()) return false;
        return this.sendReplyBox('<center> <img src = "http://i.imgur.com/hq4anWL.gif"> <br> <font size="3"><b><i><font color="B2C248">Ralphonso</i><br></font><b> <blink> Ace: Canadian Swagger </blink></b> <br> I don\'t even know what is happen </center>');
        },
...
customsymbol: function(target, room, user) {
                bannedSymbols = Config.groupsranking + '!,' + '|,' + '‽';
                if(!user.canCustomSymbol && !user.vip) return this.sendReply('You need to buy this item from the shop to use.');
                if(!target || target.length > 1) return this.sendReply('/customsymbol [symbol] - changes your symbol (usergroup) to the specified symbol. The symbol can only be one character');
                var a = target;
                a = a.replace(/([a-zA-Z ^0-9])/g, "E");
                if (a === "E" || bannedSymbols.indexOf(a) >= 0) {
